...
public class SerialHelper {
    ...
    //----------------------------------------------------
    public SerialHelper(String sPort, int iBaudRate, ReadExcute excute) {
        this.excute = excute;
        this.sPort = sPort;
...
//    }
    ...
    public void sendHex(String sHex) {
        byte[] bOutArray = MathHelper.HexToByteArr(sHex);
        send(bOutArray);
    }
    ...
    public void setHexLoopData(String sHex) {
        this._bLoopData = MathHelper.HexToByteArr(sHex);
    }
